    ...
    <div class="container">
      <div class="row">
        ...
        <br> 
          ...
          <br>
          <p>
          Insurance is increasingly being taken out over the Internet. Despite all the advantages, people fall by the wayside. Would you like to be advised by machines? We are not! That is why we founded miavita. To take advantage of the internet and still not forget people. Regardless of whether you are a customer or an employee.

We are committed. In our long years in the insurance industry, we have found time and again how difficult it can be to make complex issues customer-friendly. Over time we've gotten very good at it. From then on it was only a small step to miavita.

Every member of our team is a trained insurance expert. We also enjoy dealing with people. When can we get to know you?
          </p>
          <br/>
          <p>
          We actually wanted to introduce ourselves here. While we were fine-tuning the texts, we received numerous compliments from our customers. So we take this opportunity to talk about you. They are amazing! Thank you for the trust that you give us every day!</p>
        </div>
        <div class="col-md-6">
    ...
    <div class="container">
      <div class="row">
        ...
        <br>
          ...
          <br>
          <p>
          Suas iracundia his ea. No lorem ipsum errem ridens eam, nam an veniam equidem. Ex nec veniam singulis. No errem ridens eam, nam an veniam equidem nam an veniam equidem. No errem ridens eam, nam an veniam equidem lorem. Eu legendos definitiones vim, ea menandri voluptatum convenire quo ad lorem ipsum dolor.
          </p>
          <div class="button1">
            <a href="#menu6">Get in touch</a>
          </div>   <br>
  ...
  <div class="sectionwrapper" id="menu4"></div> 
    <div class="mainheadlinewrapper">
      <div class="mainheadline">
        ...
        <h3>Members of our team are trained insurance expert. We also enjoy dealing with people. Can we get to know you?
        </h3>
	    </div>
    </div>
    <div class="container">
    ...
    <div class="gallery js-flickity" data-flickity-options='{ 
      ...
      <div class="col-sm-4 homeblog">
        ...
        <div class="wrapper100percent">
          ...
          <p>Lorem ipsum dolor sit amet lore ipsum dolor sit amet.Lorem ipsum lore ipsum dolor sit.   </p>         
        </div> 
      </div>
      <!-- one post end --> 
      <!-- one post --> 
       ...
       <h3>Get in touch</h3> 
                ...
                <form class="wrapper100percent" method="post" action="{{route('request')}}">
                    @csrf
                        ...
                        <p><textarea placeholder="Solution : Health, Motor, Dental Insurance etc" name="solution" id="comments" rows="12" cols="5"></textarea>
						            </p>
